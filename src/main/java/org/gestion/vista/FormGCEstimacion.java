...
import org.gestion.controlador.Actividad;
import org.gestion.controlador.ModeloActividad;
import org.gestion.controlador.ModeloPerfil;
import org.gestion.controlador.Perfil;
import org.gestion.controlador.Querys;
import org.gestion.modelo.CostoEconomico;
import org.gestion.modelo.CostoTotal;
import org.gestion.modelo.NumeroJornadas;
...
public class FormGCEstimacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelCodEstimacion.setBounds(539, 13, 30, 16);

        jLabelLimpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btnLimpia.png"))); // NOI18N
        jLabelLimpiar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelAddTarea.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelCalcular.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelReporte1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelReporte1.setBounds(10, 340, 120, 30);
        ...
        jLabelMantenimiento.setBounds(10, 230, 194, 40);
    ...
    private void jLabelTareaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelTareaMouseClicked
        ...
        mantTarea.llenarPerfil();
        mantTarea.llenarActividad();
